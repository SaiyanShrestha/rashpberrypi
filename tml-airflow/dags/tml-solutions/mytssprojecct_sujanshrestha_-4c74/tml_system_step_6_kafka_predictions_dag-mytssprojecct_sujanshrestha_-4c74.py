...
@dag(dag_id="tml_system_step_6_kafka_predictions_dag_mytssprojecct_sujanshrestha_-4c74", default_args=default_args, tags=["tml_system_step_6_kafka_predictions_dag_mytssprojecct_sujanshrestha_-4c74"], schedule=None,catchup=False)
