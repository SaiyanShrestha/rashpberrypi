...
default_args = {
 ...
 'solutionname': 'mytssprojectsaiyanshresthacyber-ml-4c74',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_mytssprojectsaiyanshresthacyber-ml-4c74", default_args=default_args, tags=["tml_system_step_1_getparams_dag_mytssprojectsaiyanshresthacyber-ml-4c74"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
